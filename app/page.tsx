...
export default function Home() {
  ...
  <>
    ...
    <section className='flex flex-col w-full p-6 items-center bg-zinc-200 '>
      ...
      <Slider slides={[{src:"https://media.gazetadopovo.com.br/2012/08/35c3f03a433f11369e792d088e0f6a18-gpLarge.jpg"}]}></Slider>
    </section>
    <section className='flex flex-col w-full p-6 items-center bg-zinc-200 '>
      ...
      <Slider slides={[
          {src:`https://saojoseecopaintball.com.br/wp-content/uploads/2020/05/20200429_172038-scaled-e1619715141127.jpg`},
          {src:`https://www.paintballxtreme.com.br/wp-content/uploads/2021/04/Estrutura5.jpg`},
          {src:`https://saojoseecopaintball.com.br/wp-content/gallery/fotos-do-campo/20200429_170829.jpg`},
          {src:`https://saojoseecopaintball.com.br/wp-content/gallery/fotos-do-campo/20200429_171149.jpg`}
        ]}></Slider>
    </section>
